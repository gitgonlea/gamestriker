...
module.exports = (sequelize, DataTypes) => {
  class DailyPlayerTimeServerData extends Model {
    /**
    ...
    static associate(models) {
      DailyPlayerTimeServerData.belongsTo(models.Server, {foreignKey: 'server_id', onDelete: 'CASCADE'})
    }
  }
  DailyPlayerTimeServerData.init({
    id: {
    ...
    sequelize,
    tableName: 'daily_player_time_server_data',
  ...
  return DailyPlayerTimeServerData;
};
